...
export default function PoolMembers(MemberInfo: any) {
  ...
  return (
    ...
    <div className='flex flex-col justify-between items-start w-full rounded-sm p-1 hover:bg-primary-foreground cursor-pointer ' key={MemberInfo?.uid} onClick={() => handleMemberClick()}>
